...
public class OrgController {
    ...
    public @ResponseBody
    String getOrgProduct(@RequestBody String body, HttpServletRequest request, HttpServletResponse response) throws IOException{
...
//        }
    ...
    public @ResponseBody String  geOrgProducTran(@RequestBody String body,HttpServletRequest request, HttpServletResponse response) throws IOException{
        System.out.println("body:"+body);
        JSONObject requestcontent=JSONObject.fromObject(body);
        String orgid=requestcontent.getString("orgid");
...
//        }
    ...
    public @ResponseBody String getOrgProductbyUser(@RequestBody String body,HttpServletRequest request, HttpServletResponse response) throws IOException{
...
//        }
    ...
    public @ResponseBody String  ProductBuyInfo(@RequestBody String body,HttpServletRequest request, HttpServletResponse response) throws IOException{
        System.out.println("body:"+body);
        JSONObject requestcontent=JSONObject.fromObject(body);
        String productId=requestcontent.getString("productId");
...
//        }
    ...
    public @ResponseBody String userbuyinfo(@RequestBody String body,HttpServletRequest request, HttpServletResponse response) throws IOException{
        System.out.println("body:"+body);
        JSONObject requestcontent=JSONObject.fromObject(body);
        String userId=requestcontent.getString("userId");
        String star=requestcontent.getString("star");
...
//
    ...
    public @ResponseBody String  getOrgAsset(@RequestBody String body,HttpServletRequest request, HttpServletResponse response) throws IOException{
        System.out.println("body:"+body);
        JSONObject requestcontent=JSONObject.fromObject(body);
