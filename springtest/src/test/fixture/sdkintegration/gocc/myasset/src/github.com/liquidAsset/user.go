...
//用户查询某机构的产品
func (t *SimpleChaincode) getUserProductbyOrg(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	fmt.Println("ex02 WriteUser")
	...
	if len(args) != 3 {
		return shim.Error("getUserProductbyOrg number of arguments. Expecting 3")
	}
